...
for novel_url in urls:
    try:
        ...
        base_dir = f'/tmp/narou_dl/{title_text}'
        jp_base = os.path.join(base_dir, 'japanese')
        en_base = os.path.join(base_dir, 'english')
        ...
        for i, sub in enumerate(sublist):
            ...
            jp_path = os.path.join(jp_folder, file_name)
            ...
            # 翻訳
            translated_text = deepl.translate(sub_body_text)
